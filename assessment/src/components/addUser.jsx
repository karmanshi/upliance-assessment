...
const AddUser = () => {
  ...
  return (
    <div className="flex flex-col gap-10 justify-center w-full p-10 border border-2 rounded-md">
      <div className="w-full flex justify-center font-bold">Add User Form</div>
      ...
      <div>
        <p className="text-md font-semibold text-gray-600">
          To access the user data list please click here:{" "}
          <Link to="/users">
            <span className="underline text-blue-500">User List</span>
          </Link>
        </p>
      </div>
    </div>
